...
export function WhatsAppButton({ whatsapp, message }: WhatsAppButtonProps) {
  const handleClick = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="cursor-pointer inline-flex items-center gap-3 px-8 py-4 rounded-lg text-base font-semibold tracking-wide transition-all duration-300 hover:opacity-90 hover:scale-[1.02]"
      style={{ background: 'var(--color-whatsapp)', color: 'var(--color-ink)' }}
    >
